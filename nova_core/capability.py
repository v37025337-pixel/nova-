...
def enabled(state):
    return state["runtime_manifest"]["schema"] in ("nova.kernel.v3", "nova.kernel.v4", "nova.kernel.v5", "nova.kernel.v6", "nova.kernel.v7", "nova.kernel.v8")
...
def queue(state, rows):
    ...
    for row in rows:
        ...
        if state["runtime_manifest"]["schema"] in ("nova.kernel.v4", "nova.kernel.v5", "nova.kernel.v6", "nova.kernel.v7", "nova.kernel.v8"):
